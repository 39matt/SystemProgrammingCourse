...
public class Reader : IObserver<HttpListenerContext>, IObservable<(List<string>, HttpListenerContext)>
{
    ...
    public Reader()
    {
        ...
        //_Client = new GitHubClient(accessToken: accessToken);
    }
    ...
    public void OnNext(HttpListenerContext context)
    {
        ...
        //try
        //{
        //    var subreddit = _Client.Subreddit(parts[1]);
